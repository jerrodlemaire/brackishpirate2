...
export default function LoginScreen() {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    tabActive:     { backgroundColor: Colors.buttonBg },
    ...
    btn:         { backgroundColor: Colors.buttonBg, borderRadius: Radius.md, paddingVertical: 14, alignItems: 'center' },
    ...
    forgot:     { fontSize: Typography.sm, color: Colors.accent },
    footer: {
