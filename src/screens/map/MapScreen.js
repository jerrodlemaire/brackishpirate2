...
export default function MapScreen({ navigation }) {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    goldMarker: { width: 30, height: 30, borderRadius: 15, backgroundColor: Colors.catFish, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: Colors.textOnDark },
    goldMarkerTxt: { fontSize: 13 },

    spotCard:    { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: Colors.topbarBg, borderTopLeftRadius: Radius.xl, borderTopRightRadius: Radius.xl, padding: Spacing.lg, paddingBottom: 32, borderTopWidth: 0.5, borderTopColor: Colors.border },
    spotCardHd:  { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 8 },
    spotName:    { fontSize: Typography.md, fontWeight: '700', color: Colors.textPrimary, flex: 1 },
    spotNotes:   { fontSize: Typography.sm, color: Colors.textSecondary, marginBottom: 6, lineHeight: 20 },
    spotCoords:  { fontSize: Typography.xs, color: Colors.textMuted, marginBottom: 14 },
    closeBtn:    { padding: 4, marginLeft: 8 },
    closeBtnText:{ fontSize: 16, color: Colors.textSecondary },
    removeBtn:   { backgroundColor: Colors.dangerBg, borderRadius: Radius.md, borderWidth: 0.5, borderColor: `${Colors.danger}66`, paddingVertical: 12, alignItems: 'center' },
    removeBtnTxt:{ fontSize: Typography.base, color: Colors.danger, fontWeight: '600' },

    radarBar:       { position: 'absolute', bottom: 60, left: 12, right: 12, backgroundColor: 'rgba(13,33,55,0.95)', borderRadius: Radius.lg, paddingHorizontal: 12, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', gap: 10, borderWidth: 0.5, borderColor: Colors.border },
    ...
    radarPlayIcon:  { fontSize: 13, color: Colors.textOnDark },
    radarTimeline:  { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 2 },
    radarTick:      { flex: 1, height: 4, borderRadius: 2, backgroundColor: Colors.border },
    radarTickActive:{ backgroundColor: Colors.brackishWater, height: 7, borderRadius: 3.5 },
    radarTime:      { fontSize: Typography.xs, color: Colors.textSecondary, width: 62, textAlign: 'right' },
    ...
    modalTitle:    { fontSize: Typography.lg, fontWeight: '700', color: Colors.textOnDark, fontFamily: 'Georgia', marginBottom: 4 },
    modalInput:    { backgroundColor: Colors.inputBg, borderRadius: Radius.md, borderWidth: 0.5, borderColor: Colors.border, color: Colors.textOnDark, fontSize: Typography.base, padding: 12 },
    modalInputNotes:{ height: 80, textAlignVertical: 'top' },
    modalSaveBtn:  { backgroundColor: Colors.buttonBg, borderRadius: Radius.md, paddingVertical: 14, alignItems: 'center' },
    modalSaveTxt:  { fontSize: Typography.base, color: Colors.buttonText, fontWeight: '700' },
    modalCancelBtn:{ paddingVertical: 10, alignItems: 'center' },
    modalCancelTxt:{ fontSize: Typography.base, color: Colors.textMuted },
  }), [Colors])
